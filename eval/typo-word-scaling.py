"""Five frozen weight-only scales; development partitions only, no export or fitting."""
import hashlib
import json
...
def main():
    ...
    for ratio in RATIOS:
        ...
        result={'wordScale':ratio,'typoRaw':typo_result,'expanded':expanded_result,'navigationSemanticRaw':nav_result,'gates':passes,'allGatesPassed':all(passes.values())}
